...
//   );
//   const keyIconMap = {
//   fixTime: <AccessTimeIcon fontSize="small" sx={{ verticalAlign: 'middle' }} />,
//   address: <HomeIcon fontSize="small" sx={{ verticalAlign: 'middle' }} />,
//   speed: <SpeedIcon fontSize="small" sx={{ verticalAlign: 'middle' }} />,
//   totalDistance: <RouteIcon fontSize="small" sx={{ verticalAlign: 'middle' }} />,
// };
...
//                     >
//                       <DirectionsIcon sx={{ color: "#4634eb" }} />
//                     </IconButton>)}
